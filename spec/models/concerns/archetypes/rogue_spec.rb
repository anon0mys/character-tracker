...
RSpec.describe Archetypes::Rogue do
  ...
  describe "specific features" do
    ...
    it "has Expertise at level 1" do
      expect(archetype.feature_at_level?(1, "Expertise")).to be true
    end

    it "has Sneak Attack at level 1" do
      expect(archetype.feature_at_level?(1, "Sneak Attack")).to be true
    end

    it "has Thieves Cant at level 1" do
      expect(archetype.feature_at_level?(1, "Thieves' Cant")).to be true
    end
