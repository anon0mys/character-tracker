    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
                <div>
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-1 sm:mb-2 text-primary">Games</h1>
                    <p className="text-sm sm:text-base text-muted-foreground">Manage your D&D campaigns and adventures</p>
                </div>
                <Button onClick={() => setOpen(true)} size="lg" className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90  min-h-[44px]">Create Game</Button>
            </div>
            {gameCards.length > 0 ? (
